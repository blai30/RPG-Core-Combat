...
public class RFX4_UberDistortionGUI: ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor m, MaterialProperty[] properties)
    {
        ...
        var _TintDistortion = ShaderGUI.FindProperty("_TintDistortion", properties);
        ...
        var _FresnelInvert = ShaderGUI.FindProperty("_FresnelInvert", properties);
        ...
        if (Mathf.Abs(_UseMainTex.floatValue - 1) < tollerance)
        {
            ...
            m.ShaderProperty(_TintDistortion, _TintDistortion.displayName);
        ...
        if (Mathf.Abs(_UseFresnel.floatValue - 1) < tollerance)
        {
            ...
            m.ShaderProperty(_FresnelInvert, _FresnelInvert.displayName);
